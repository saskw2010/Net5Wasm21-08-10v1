...
{
    public partial class EditProductindexComponent : ComponentBase
    {
        ...
        protected async System.Threading.Tasks.Task Load()
        {
            ...
            var net5WasmconnGetProductByIdResult = await Net5Wasmconn.GetProductById(id:Convert.ChangeType(Id, Type.GetTypeCode(typeof(int))));
        ...
        {
            UriHelper.NavigateTo("productindex");
        }
        ...
        protected async System.Threading.Tasks.Task Form0Submit(Net5Wasm.Models.Net5Wasmconn.Product args)
        {
            try
            {
                var net5WasmconnUpdateProductResult = await Net5Wasmconn.UpdateProduct(id:Convert.ChangeType(Id, Type.GetTypeCode(typeof(int))), product:product);
